...
This module handles inference for machine learning models (e.g., Random Forest) where feature selection was performed using **Boruta**. It ensures that the input data strictly matches the features selected during training. Current version only supports human samples.
